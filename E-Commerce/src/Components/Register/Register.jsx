  ...
  let validateScheme = Yup.object({
    ...
    password: Yup.string()
      .matches(
        ...
        "must be * Start with a letter (either uppercase or lowercase). * Be between 6 and 9 characters in total. * Can only contain letters (A-Z or a-z) and numbers (0-9)"
      )
              ...
              <button
                ...
                className={
                  !(formik.isValid && formik.dirty)
                    ? "btn btn-lg mt-2 ms-auto"
                    : "btn btn-lg bg-main text-white mt-2 ms-auto"
                }
                type="submit"
              >
                Register Now
