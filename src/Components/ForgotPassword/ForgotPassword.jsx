  ...
  return <>
    ...
    <div className='verifyCode d-none'>
      <form onSubmit={verifyFormik.handleSubmit} className='mx-auto w-75 my-5'>
        {error2 !== null ? <div className="alert alert-danger">{error2}</div> : ''}
        ...
        {isLoading2 ?
          ...
          : <button disabled={!(verifyFormik.dirty && verifyFormik.isValid)} className='btn btn-lg bg-main text-white my-2' type='submit'>verifying</button>
        }
      </form>
    </div>
  </>
